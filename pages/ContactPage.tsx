        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div>
                ...
                <div className="space-y-4 text-viniela-gray">
                  <div className="flex items-start">
                    <i className="fa-solid fa-location-dot w-6 h-6 mr-4 mt-1 text-viniela-gold flex-shrink-0" aria-hidden="true"></i>
                  ...
                  <div className="flex items-start">
                    <i className="fa-solid fa-phone w-6 h-6 mr-4 mt-1 text-viniela-gold flex-shrink-0" aria-hidden="true"></i>
                    <span>
                  ...
                  <div className="flex items-start">
                    <i className="fa-solid fa-envelope w-6 h-6 mr-4 mt-1 text-viniela-gold flex-shrink-0" aria-hidden="true"></i>
                    <span>
              ...
              <div>
                <h3 className="text-2xl font-bold text-viniela-dark mb-4">{t.contact.ourLocation}</h3>
            ...
            <div className="lg:col-span-7 bg-white p-8 rounded-2xl shadow-lg">
              {isSubmitted ? (
                <div className="text-center flex flex-col items-center justify-center h-full">
                  <i className="fa-solid fa-check-circle fa-4x text-green-500 mb-6" aria-hidden="true"></i>
                ...
                <>
                  <h2 className="text-3xl font-bold text-viniela-dark mb-6">{t.contact.formTitle}</h2>
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      <label htmlFor="name" className="form-label">{t.contact.fullName}</label>
                      <input type="text" id="name" name="name" className="form-input" value={formState.name} onChange={handleInputChange} required />
                    </div>
                    <div>
                      <label htmlFor="email" className="form-label">{t.contact.email}</label>
                      <input type="email" id="email" name="email" className="form-input" value={formState.email} onChange={handleInputChange} required />
                    </div>
                    <div>
                      <label htmlFor="subject" className="form-label">{t.contact.subject}</label>
                      <input type="text" id="subject" name="subject" className="form-input" value={formState.subject} onChange={handleInputChange} required />
                    </div>
                    <div>
                      <label htmlFor="message" className="form-label">{t.contact.message}</label>
                      <textarea id="message" name="message" rows={5} className="form-input" value={formState.message} onChange={handleInputChange} required></textarea>
                    </div>
                    <div>
                      <button type="submit" className="w-full btn-primary mt-2">{t.contact.sendMessage}</button>
                    </div>
                  </form>
                </>
              )}
